...
export class Tab4Page implements OnInit {
  ...
  getAllOrders() {
    this.auth.getAllOrders(this.status).subscribe({
      next: async (value: any) => {
        console.log('Fetched Order for ' + this.status);
  ...
  acceptOrder(orderId: any) {
    this.auth.AcceptRejectOrder(orderId, 4).subscribe({
      next: async (value: any) => {
        console.log(value);
        this.getAllOrders();
      },
  ...
  rejectOrder(orderId: any) {
    this.auth.AcceptRejectOrder(orderId, 5).subscribe({
      next: async (value: any) => {
        console.log(value);
        this.getAllOrders();
      },
